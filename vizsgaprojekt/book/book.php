		...
		<div class="datas" id="box">
			<form>
				<div class="form-group div1 row">
					<div class="first col">
						<div class="second">
							...
							<div class="third">
								<input class="form-control" type="number" id="adultsnumber" placeholder="Adults">
							</div>
						</div>
					</div>
					<div class="first col">
						<div class="second">
							...
							<div class="third">
								<input class="form-control" type="number" id="childrennumber" placeholder="Children">
							</div>
						</div>
					</div>
					<div class="first col">
				...
				<div class="form-group div3">
					...
					<button class="learn-more" id="button">
	...
	<section class="dark">
		<div class=" py-4">
			<h1 class="h1 text-center" id="pageHeaderTitle">Rooms</h1>
