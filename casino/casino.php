...
<div class="basic col-12 col-sm-12 col-md-12 col-lg-12">
    ...
    <div class="row basicinfo">
        <div class="col-12 col-sm-6 col-md-6 col-lg-3 info">
            <div>
                <p class="red"><svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi mb-2 bi-suit-club-fill" viewBox="0 0 16 16">
        ...
        <div class="col-12 col-sm-6 col-md-6 col-lg-3 info">
            <div>
                <p class="green"><svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="mb-2 bi bi-coin" viewBox="0 0 16 16">
        ...
        <div class="col-12 col-sm-6 col-md-6 col-lg-3 info">
            <div>
                <p class="red"><svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="mb-2 bi bi-tv-fill" viewBox="0 0 16 16">
        ...
        <div class="games col-12 col-sm-12 col-md-12 col-lg-12">
            ...
            <div class="row gamesitems">
                ...
                <div class="customcard3 col-12 col-sm-6 col-md-6 col-lg-4">
                    <img src="pictures/casino/craps1.jpg" class="card-img-top" alt="...">
                    <div class="card-body">
        ...
        <div class="pokers col-12 col-sm-12 col-md-12 col-lg-12">
            <div class="row pokerheader">
                <div class="col-12 col-sm-6 col-md-6 col-lg-4 pokerheadszoveg">
                    <h1>POKER GAMES</h1>
                    <p>Step into our 4500-square-foot casino poker room and let the excitement spread.</p>
                </div>
            ...
            <div class="row pokercards">
                ...
                <div class="card col-12 col-sm-6 col-md-6 col-lg-4">
                    <div class="content">
                        <h2 class="title">TEXAS HOLD'EM BONUS POKER</h2>
                ...
                <div class="card col-12 col-sm-6 col-md-6 col-lg-4">
                    <div class="content">
                        ...
                        <p class="copy">When you have a good hand in this exciting table game, just Let It Ride. You could win a cash jackpot of up to $25000 on this high-stakes Five Card Stud poker variation.</p>
                    </div>
                </div>
