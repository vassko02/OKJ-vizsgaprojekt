...
<div class="basic">
    ...
    <div class="row basicinfo">
        <div class="col-sm-6 col-md-6 col-lg-3 info">
            <div>
                <p class="red"><svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi mb-2 bi-suit-club-fill" viewBox="0 0 16 16">
  <path d="M11.5 12.5a3.493 3.493 0 0 1-2.684-1.254 19.92 19.92 0 0 0 1.582 2.907c.231.35-.02.847-.438.847H6.04c-.419 0-.67-.497-.438-.847a19.919 19.919 0 0 0 1.582-2.907 3.5 3.5 0 1 1-2.538-5.743 3.5 3.5 0 1 1 6.708 0A3.5 3.5 0 1 1 11.5 12.5z"/>
        ...
        <div class="col-sm-6 col-md-6 col-lg-3 info">
            <div>
                <p class="green"><svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="mb-2 bi bi-coin" viewBox="0 0 16 16">
  ...
  <path d="M8 13.5a5.5 5.5 0 1 1 0-11 5.5 5.5 0 0 1 0 11zm0 .5A6 6 0 1 0 8 2a6 6 0 0 0 0 12z"/>
        ...
        <div class="col-sm-6 col-md-6 col-lg-3 info">
            <div>
                <p class="red"><svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="mb-2 bi bi-tv-fill" viewBox="0 0 16 16">
