                                    ...
                                    <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                      <tr>
                                        <td style="padding-right: 0px;padding-left: 0px;" align="center">
                                          ...
                                          <img align="center" border="0" src="https://cdn.templates.unlayer.com/assets/1637739231457-ccc.png" alt="Tick Icon"
                                            title="Tick Icon"
                                ...
                                <tr>
                                  <td class="v-container-padding-padding"
                                    ...
                                    <h1 class="v-font-size"
                                      ...
                                      <strong>Your reservation has been confirmed!<br /></strong>
                                    </h1>
                                  ...
                                  <td class="v-container-padding-padding"
                                    ...
                                    <div
                                      ...
                                      <p style="font-size: 14px; line-height: 170%;"><span
                                          style="font-size: 16px; line-height: 27.2px;">Thank you for choosing our hotel. We
                                          wish we will live up to your expectations.<br /></span></p>
                                    </div>
                  ...
                  <div class="u-row"
                    ...
                    <div style="border-collapse: collapse;display: table;width: 100%;background-color: transparent;">
                      ...
                      <div class="u-col u-col-63p66"
                        style="max-width: 320px;min-width: 382px;display: table-cell;vertical-align: top;">
                        <div
                          style="background-color: #cca250;width: 100% !important;border-radius: 0px;-webkit-border-radius: 0px; -moz-border-radius: 0px;">
                          <!--[if (!mso)&(!IE)]><!-->
                          <div
                            style="padding: 20px;border-top: 1px solid #CCC;border-left: 1px solid #CCC;border-right: 1px solid #CCC;border-bottom: 1px solid #CCC;border-radius: 0px;-webkit-border-radius: 0px; -moz-border-radius: 0px;">
                            <!--<![endif]-->
                              ...
                              <tbody>
                                <tr>
                                  <td class="v-container-padding-padding"
                                    ...
                                    <h1 class="v-font-size"
                                      style="margin: 0px; color: #ffffff; line-height: 160%; text-align: center; word-wrap: break-word; font-weight: normal; font-family: Montserrat,sans-serif; font-size: 20px;">
                                      <strong>The Real Life Paradise Awaits<br /></strong>
                                    </h1>
                                    ...
                                    <div style="color: #f1f8f5; line-height: 200%; text-align: left; word-wrap: break-word;">
                                      <p style="font-size: 14px; line-height: 200%;"><span
                                          style="color: #f7e1b5; font-size: 14px; line-height: 28px;"><strong><span
                                              style="font-size: 14px; line-height: 28px;">✓</span></strong>&nbsp;</span> Most
                                        luxurious rooms</p>
                                      <p style="font-size: 14px; line-height: 200%;"><span
                                          style="color: #f7e1b5; font-size: 14px; line-height: 28px;"><strong>✓</strong></span>&nbsp;
                                        3 Michelin Star restaurant</p>
                                      <p style="font-size: 14px; line-height: 200%;"><span
                                          style="color: #f7e1b5; font-size: 14px; line-height: 28px;">✓</span>&nbsp;
                                        4550-square-meter Casino</p>
                                      <p style="font-size: 14px; line-height: 200%;"><span
                                          style="color: #f7e1b5; font-size: 14px; line-height: 28px;">✓</span>&nbsp; The best
                                        experience in your life so far</p>
                                    </div>
                              ...
                              <tbody>
                                <tr>
                                  <td class="v-container-padding-padding"
                                    ...
                                    <h1 class="v-font-size"
                                      style="margin: 0px; line-height: 160%; text-align: center; word-wrap: break-word; font-weight: normal; font-family: Montserrat,sans-serif; font-size: 26px;">
                                ...
                                <tr>
                                  <td class="v-container-padding-padding"
                                    ...
                                    <div align="center">
                                      ...
                                      <a href="http://diak.jedlik.eu/~PeacefulParadise/contactus" target="_blank"
                          ...
                          <tbody>
                            <tr>
                              <td class="v-container-padding-padding"
                                ...
                                <h1 class="v-font-size"
                                  style="margin: 0px; line-height: 160%; text-align: center; word-wrap: break-word; font-weight: normal; font-family: Montserrat,sans-serif; font-size: 33px;">
                                  <strong>Thank you for contacting our support!<br /></strong>
                                </h1>
                            ...
                            <tr>
                              <td class="v-container-padding-padding"
                                ...
                                <div
                                  style="color: #444444; line-height: 170%; text-align: center; word-wrap: break-word;">
                                  <p style="font-size: 14px; line-height: 170%;"><span
                                      style="font-size: 16px; line-height: 27.2px;">We will try to help you as soon as possible!<br /></span></p>
                                </div>
