        ...
        || $usernamehibauzenet !='' || $emailHibauzenet != '') echo "right-panel-active"; ?>" id="loginout">
            ...
            <div class="form-loginout sign-in-loginout urlap">
                <form action="" method="POST">
                    ...
                    <div class="input-signin">
                        <input type="text"   value="<?php if (isset($_POST['usernameperemail'])) {echo $_POST['usernameperemail'];} ?>" id="validUsernameperEmail"  name="usernameperemail"  required="required" />
