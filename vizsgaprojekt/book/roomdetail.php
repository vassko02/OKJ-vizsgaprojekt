...
<div class="row">
    ...
    <div id="carouselExampleCaptions" class="carousel slide carousel-fade" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
            ...
            <img src="book/pictures/room1.jpeg" class="d-block w-100" alt="...">
         
            </div>
            <div class="carousel-item">
            <img src="book/pictures/room2.jpg" class="d-block w-100" alt="...">
          
            </div>
            <div class="carousel-item">
            <img src="book/pictures/room3.jpg" class="d-block w-100" alt="...">
